...
public class OI {
	...
	one.whileHeld(new Shoot(.85,.85,1));//ultra high shot
	
	eight.toggleWhenPressed(new Shoot(.68,.68,.75));//high
	
	twelve.toggleWhenPressed(new Shoot(1,.5, 0));//vault
